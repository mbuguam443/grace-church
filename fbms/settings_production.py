...
# NOTE: /static/ is shadowed by Apache at the document root and is
# unreliable on this host (currently returns 404 for everything).
# Serve through Passenger/WhiteNoise via a path Apache does not intercept.
STATIC_URL = '/assets/'
STATICFILES_DIRS = [BASE_DIR / 'static']
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Serve static straight from the source dirs (no reliance on Apache or
# on collectstatic having run). Works with plain file-based deploys.
...
SITE_URL = os.environ.get('SITE_URL', 'http://gracechurch.schones-heim-builders.co.ke')
